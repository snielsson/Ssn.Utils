...
namespace Ssn.Utils.Extensions {
    ...
    public static class ObjectExtensions {
        ...
        public static string ToJson<T>(this T @this) {
            // Serialize @this to json using your favorite 
            // JSON serializer and return the json as a string.
            return JSON.Serialize(@this, _jilCloneOptions);
        }
        ...
        public static bool TryValidate(this object @this, List<ValidationResult> validationResults) {
